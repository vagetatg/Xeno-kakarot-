...
EXTRA_PLUGINS_REPO = getenv(
    "EXTRA_PLUGINS_REPO",
    "https://github.com/vagetatg/Xeno-kakarot-Extra",
)
...
GITHUB_REPO = getenv("GITHUB_REPO", "https://github.com/vagetatg/Xeno-kakarot-")
