    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                ...
                await self.one.join_chat("Baby_dark_music_bot2")
                await self.one.join_chat("SHINOBI_HEADQUATERS")
            except:
                pass
            assistants.append(1)
        ...
        if config.STRING2:
            ...
            try:
                ...
                await self.two.join_chat("Baby_dark_music_bot2")
                await self.two.join_chat("SHINOBI_HEADQUATERS")
            except:
                pass
            assistants.append(2)
        ...
        if config.STRING3:
            ...
            try:
                ...
                await self.three.join_chat("Baby_dark_music_bot2")
                await self.three.join_chat("SHINOBI_HEADQUATERS")
            except:
                pass
            assistants.append(3)
        ...
        if config.STRING4:
            ...
            try:
                ...
                await self.four.join_chat("Baby_dark_music_bot2")
                await self.four.join_chat("SHINOBI_HEADQUATERS")
            except:
                pass
            assistants.append(4)
        ...
        if config.STRING5:
            ...
            try:
                ...
                await self.five.join_chat("Baby_dark_music_bot2")
                await self.five.join_chat("SHINOBI_HEADQUATERS")
            except:
                pass
            assistants.append(5)
